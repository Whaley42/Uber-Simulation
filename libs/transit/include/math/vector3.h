...
class Vector3 {
  ...
  * 
  * @param[in] index The specified coordinate represented by an int
  * 
  * @return The float at that coordinate 
  */
  ...
  * 
  * @return The magnitude represented by a float
  */
  float Magnitude() { return std::sqrt(x * x + y * y + z * z); }

 /**
  * @brief The vector unit
  * 
  * @return The unit represented as a 3D vector
  */
  Vector3 Unit() { return (*this) / Magnitude(); }

 /**
  * @brief The distance of a vector
  * 
  * @param[in] v The vector being specified
  * 
  * @return The distance of said vecotr point as a float
  */
 ...
 /**
  * @brief Print the vector as a formatted string
  */
  void Print();
};
#endif
